...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-53EYV654T5"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-53EYV654T5');
</script>
<body <?php body_class(["d-flex flex-column h-100"]); ?>>
<?php wp_body_open(); ?>
<a href="#main" class="visually-hidden-focusable" tabindex="0"><?php esc_html_e(
  "Skip to main content",
  "rbn-pw"
); ?></a>
<?php
//get_template_part('template-parts/special-collections-branding', 'global-header', []);
?>
