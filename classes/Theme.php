...
class Theme
{
  ...
  function load_scripts()
  {
    ...
    wp_enqueue_script(
      "bootstrap",
      get_theme_file_uri("/dist/js/vendor/bootstrap.bundle.min.js"),
      [],
      filemtime(
        plugin_dir_path(__DIR__) . "dist/js/vendor/bootstrap.bundle.min.js"
      ),
      true
    );
    wp_enqueue_script(
      "mainjs",
      get_theme_file_uri("dist/js/app.min.js"),
      ["bootstrap"],
      filemtime(plugin_dir_path(__DIR__) . "dist/js/app.min.js"),
      true
    );
  ...
  function load_styles()
  {
    ...
    wp_enqueue_style(
      "theme",
      get_theme_file_uri("/dist/css/app.min.css"),
      ["style"],
      filemtime(__DIR__ . "/../dist/css/app.min.css"),
      "all"
    );
    if (is_rtl()) {
      wp_enqueue_style(
        "rtl",
        get_theme_file_uri("dist/css/rtl.css"),
        [],
        $this->theme_version,
        "all"
      );
  ...
  function block_editor_scripts()
  {
    ...
    //   ["wp-blocks", "wp-dom"],
    //   filemtime($this->theme_path . "/dist/js/editor.js"),
    //   true
    // );
  }
  ...
  function register_acf_blocks()
  {
    if (function_exists("acf_register_block_type")) {
      register_block_type($this->theme_path . "/blocks/contributors-grid", [
        "icon" => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-grid-3x3-gap" viewBox="0 0 16 16">
      ...
      register_block_type($this->theme_path . "/blocks/profile-grid", [
      ...
      register_block_type($this->theme_path . "/blocks/logos-row", [
        "icon" => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-columns-gap" viewBox="0 0 16 16">
  ...
  function sidebars()
  {
    ...
    register_sidebar([
      ...
      "before_widget" =>
        '<div class="widget %2$s spotlight"><p class="fst-italic">',
      "after_widget" => "</p></div>",
      "before_title" => "",
      "after_title" => "",
    ]);
    ...
    register_sidebar([
      "name" => __("Events Archive - Header - Spotlight Attribution", "rbn-pw"),
      "id" => "events-header-spotlight-attribution",
      "before_widget" =>
        '<cite class="widget %2$s fst-italic text-end">&mdash; ',
      "after_widget" => "</cite>",
      "before_title" => "",
      "after_title" => "",
    ]);
    ...
    register_sidebar([
      "name" => __("News Archive - Header - Spotlight Attribution", "rbn-pw"),
      "id" => "news-header-spotlight-attribution",
      "before_widget" => '<cite class="widget %2$s text-end">&mdash; ',
      "after_widget" => "</cite>",
      "before_title" => "",
      "after_title" => "",
    ]);
