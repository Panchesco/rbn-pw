       ...
       wp_nav_menu([
         ...
         "items_wrap" =>
           '<ul class="p-0 m-0 sans-serif text-uppercase">%3$s</ul>',
       ]);
     endif; ?>
					</div><!-- /.col -->
     ...
     ?>
				...
				<div class="col d-xl-flex">
					<p class="h6 has-white-color pt-1 pb-2">&copy; <?php _e(
       "Copyright",
       "rbn-pw"
     ); ?> <?php echo date(
   "Y"
 ); ?> &ndash; Arizona Board of Regents For The University of Arizona</p>
					<span class="h6 pt-1 pb-2 px-3 d-none d-xl-inline-block" role="presentation">|</span>
					<p class="h6 pt-1 pb-2"><a class="has-ivory-buff-color" href="https://lib.arizona.edu/policies/copyright-take-down-request"><?php _e(
