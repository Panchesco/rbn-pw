			...
			<div class="container">
				<div class="row py-6 ">
					...
					<div class="col py-4 py-xl-0 col-xl-3">
						...
						<?php endif;?>
						<p class="text-end"><a class="no-decoration" href="#header" title="Scroll to top"><svg id="TOP" xmlns="http://www.w3.org/2000/svg" width="87.338" height="62" viewBox="0 0 87.338 62">
