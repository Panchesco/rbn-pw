		...
		<div class="col-xl-6">
			<?php if( isset( $event_cta['button_url'] ) && ! empty( $event_cta['button_url'] ) ) :?>
				<div class="d-flex justify-content-center justify-content-lg-start text-center wp-block-button">
					<a class="wp-block-button__link has-vizcaya-palm-background-color w-100 mb-6" target="_blank" href="<?php echo $event_cta['button_url'];?>"><?php echo $event_cta['button_text'];?></a>
				</div>
			<?php endif;?>
			<div class="grouping">
